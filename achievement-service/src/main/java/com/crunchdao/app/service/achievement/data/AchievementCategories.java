...
import com.crunchdao.app.service.achievement.entity.AchievementCategory.AchievementCategoryBuilder;
...
public class AchievementCategories {
	...
	public static final AchievementCategory SOCIAL = builder()
	...
	public static final AchievementCategory TOURNAMENT = builder()
	...
	public static final AchievementCategory MISCELLANEOUS = builder()
	...
	public static final AchievementCategory FORUM = builder()
	...
	private static AchievementCategoryBuilder builder() {
